  ...
  run: async ({ interaction, client }) => {
    ...
    try {
      ...
      if (isRegistered) {
        ...
        interaction.reply(
          `You have registered the Riot ID: ${summonerDetails.gameName} #${summonerDetails.tagLine}`,
        );
      } else {
        interaction.reply(
          "You do not have a summoner registered. To register your Riot ID, use /register.",
        );
      }
    } catch (error) {
      console.error(error);
